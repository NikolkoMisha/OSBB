...
<!--ADMIN-->
	<sec:authorize access="isAuthenticated()">
			...
			<form:form class="form-horizontal" action="/Additionally/Spending" method="POST" modelAttribute="spending" enctype="multipart/form-data">
              
                <div class="row balance" style="margin-top:25px;">
                    <div class="form-group col-md-12" style="margin:0; padding:0;">
                        <div class="col-md-3 bal_dod text-left">
                ...
                <div class="row balance text-center" style=" padding-right: 0px;">
                    <div class="col-md-12">
                        <div class="row table-head">
                            ...
                            <div class="col-md-4 text-center">Ціль витрати</div>
                            <div class="col-md-3 text-center">Сума</div>
                            <div class="col-md-2 text-center">Дата</div>
                   ...
                   <c:forEach items="${spendings}" var="spending" varStatus="status"> 
                        <div class="row table_row">
                            ...
                            <div class="col-md-4 text-center">${spending.name}</div>
                            <div class="col-md-3 text-center">${spending.price} грн</div>
                            <div class="col-md-2 text-center">${spending.date}</div>
                      
                   	  <sec:authorize access="isAuthenticated()">
						<sec:authorize access="hasRole('ROLE_ADMIN')">
                            <div class="col-md-1 text-center"><a class="glyphicon glyphicon-pencil" href="/admin/Tenants/TenantInfo/update/${userInfo.id}"></a></div>
                           <div class="col-md-1 text-center"><a class="glyphicon glyphicon-remove" href="/Additionally/Spending/delete/${spending.id}"></a></div>
                     	</sec:authorize>
                      </sec:authorize>
                        </div>
                     </c:forEach>
