...
public class SizeTag extends SimpleTagSupport {
	...
	private String title = "Показувати по : ";
	private int size;
	...
	public void doTag() throws JspException, IOException {
		...
		sw.append("<div class='dropdown'><button class='backlight' type='button' data-toggle='dropdown'>");// в button можна задати клас і міняти вид 
		sw.append(title);
